<!-- Referensi: https://www.malasngoding.com/membuat-login-multi-user-level-dengan-php-dan-mysqli/-->
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text">Sistem Pendistribusian Bantuan Logistik</h4>
							</div>
                                            ...
                                            if(isset($_GET['akses'])) {
                                                if($_GET['akses']=='gagal') {
                                                    echo "<div class='alert alert-danger'>
											                ...
											                Username atau Password tidak sesuai!</div>";
